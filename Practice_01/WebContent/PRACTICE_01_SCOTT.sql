...
SELECT USERID, USERNAME, USERAGE, JOBNAME, JOBID FROM VIEW_USER WHERE USERID = 1
;
...
UPDATE TBL_USER SET USERNAME ='±èÀÌ¹ÚÃ¶³ç', USERBIRTH = '1993-11-13', JOBID = '4' WHERE USERID = '1';
